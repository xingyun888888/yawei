  ...
  <div class="cright">
     <form  action="{{url('/admin/carousel/add')}}" method="post"  enctype="multipart/form-data"  >
	  ...
	  <div class="form-group">
		<label for="picture">轮播图片上传</label>
	  ...
	  <div class="form-group">
		<label for="describe">图片说明</label>		
	   <textarea class="form-control" rows="3" id="describe" name="describe" placeholder="一句话对图片进行描述..."></textarea>
	  </div>
