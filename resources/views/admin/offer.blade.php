...
@section("content")
 ...
 <div class="cright">
	<div class="action" style="margin:20px;">      
			<a class="btn btn-success" href="/admin/offer/add">新增</a>
	...
	<tr class="active">         
	  ...
	  <td class="active text-center">{{$item->offer_title}}</td>
	  <td class="active text-center">{{$_SERVER['HTTP_HOST'].$item->offer_img}}</td>
	  <td class="active text-center">
	    <a href="{{url('/admin/offer/remove/'.$item->id)}}">删除</a>
	    <a href="{{url('/admin/offer/remove/'.$item->id)}}">查看</a>
